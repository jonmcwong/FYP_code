...
from lucidrains_reformer.reformer_pytorch.reversible import ReversibleSequence
...
#         self.token_emb = nn.Embedding(num_tokens, emb_dim)
        self.token_emb = nn.Embedding(num_tokens, emb_dim, padding_idx=Constants.PAD)
