...
from lucidrains_reformer.reformer_pytorch.reformer_pytorch import Reformer, ReformerLM, LSHSelfAttention
...
class Autopadder(nn.Module):
    def __init__(self, net):
        super().__init__()
        assert isinstance(net, (LSHSelfAttention, Reformer, ReformerLM)), 'only modules LSHSelfAttention, Reformer, ReformerLM, ReformerEncDec accepted'
        self.net = net
